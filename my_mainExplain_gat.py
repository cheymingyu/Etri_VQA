...
from my_gqa_dataset_entry import GQATorchDataset, GQATorchDataset_collate_fn
from my_pipeline_model_gat import PipelineModel  # use gat model
import json
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (data_batch) in enumerate(train_loader):
        ...
        questionID, questions, gt_scene_graphs, programs, full_answers, short_answer_label, types, questions_mask, full_answers_mask = data_batch
        del questionID
        questions, gt_scene_graphs, programs, full_answers, short_answer_label, questions_mask, full_answers_mask = [
            datum.to(device=cuda, non_blocking=True) for datum in [
                questions, gt_scene_graphs, programs, full_answers, short_answer_label, questions_mask,
                full_answers_mask
            ]
        ]
